...
export function Footer() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 px-80">
      <footer className="relative w-full rounded-t-[2.5rem] border border-yellow-200/10 bg-gradient-to-b from-indigo-950 via-blue-950 to-indigo-950 shadow-[0_-4px_16px_rgba(0,0,0,0.4)]">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,rgba(96,165,250,0.25),transparent_65%)]" />
